...
class Robot(wpilib.IterativeRobot):
    ...
    def robotInit(self):
        ...
        self.talon.configSelectedFeedbackSensor(
            WPI_TalonSRX.FeedbackDevice.QuadEncoder, self.kPIDLoopIdx, self.kTimeoutMs
        )
        ...
        self.talon.config_kF(0, 1.705, self.kTimeoutMs)
        self.talon.config_kP(0, 0, self.kTimeoutMs)
        self.talon.config_kI(0, 0, self.kTimeoutMs)
        self.talon.config_kD(0, 0, self.kTimeoutMs)
        # set acceleration and vcruise velocity - see documentation
        self.talon.configMotionCruiseVelocity(300, self.kTimeoutMs)
        self.talon.configMotionAcceleration(300, self.kTimeoutMs)
        # zero the sensor
    ...
    def teleopPeriodic(self):
        ...
        leftYstick = -1.0 * self.joy.getThrottle()
        ...
        targetPos = max(leftYstick * 6300, 0)
        ...
        if self.joy.getRawButton(11):
            ...
            self.talon.set(WPI_TalonSRX.ControlMode.PercentOutput, 0)
